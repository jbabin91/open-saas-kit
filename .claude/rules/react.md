...
## Project Hooks (To Implement)

### useIsMobile

Pattern for mobile viewport detection (< 768px breakpoint):

```tsx
// apps/web/src/hooks/use-mobile.ts (create this file)
...
Should return `boolean` and update on window resize via `matchMedia`.
